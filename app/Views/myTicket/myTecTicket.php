<?php echo view('template/menu/tecMenu');?>
	...
	<table class="table mt-4">
		...
		<tbody>
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="Tickets/responderTec/<?php echo $chamado->id ?>" class="btn btn-primary">Responder</a>
                    <a href="myTicket/delete/<?php echo $chamado->id ?>">Excluir</a>
                </td>
            </tr>
            <?php endforeach; ?>
		</tbody>
